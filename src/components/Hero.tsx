...
export default function Hero() {
    ...
    return (
        <section className="hero" id="hero" ref={heroRef} aria-label="Hero">
            <div className="hero-watermark" aria-hidden="true">MindFrix</div>
            ...
            <div className="container hero-container">
                ...
                <p className="hero-subtitle">
                    We build custom web apps, AI automation, and sales systems that
                    eliminate manual work — so you can focus on growing revenue, not managing chaos.
                </p>

                {/* Buttons */}
                <div className="hero-buttons">
                    <a href="/contact" className="btn-primary hero-btn-primary" id="hero-cta-btn">
            ...
            <div className="hero-media-container" ref={mediaRef}>
                <div className="hero-media-image-wrapper">
                    <img
                        ...
                        alt="Custom business dashboard with AI chatbot integration and automated workflow connections — built by MindFrix"
                        loading="eager"
                        fetchPriority="high"
                        width={1200}
                        height={675}
